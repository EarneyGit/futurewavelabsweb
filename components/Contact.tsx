...
const Contact = () => {
  ...
  return (
    <section id="contact" className="pt-8 pb-8 bg-background scroll-mt-24">
          ...
          <div className="flex flex-col justify-between">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70">hello@earney.in</p>
                  </div>
                </div>
                
                <div className="flex items-start gap-4">
                  <div className="p-3 rounded-full bg-gradient-to-br from-primary/10 via-secondary/10 to-accent/10">
                    <FiPhone className="text-xl" style={{ color: '#a855f7' }} />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <div className="p-3 rounded-full bg-gradient-to-br from-primary/10 via-secondary/10 to-accent/10">
                    <FiMapPin className="text-xl" style={{ color: '#c084fc' }} />
                  </div>
                  <div>
                    <h4 className="font-medium mb-1">Visit Us</h4>
                    <p className="text-foreground/70">Kolapakkam, Chennai, India</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-12">
              ...
              <div className="flex gap-4">
                ...
                <a href="https://www.instagram.com/earneysolutions/" target="_blank" rel="noopener noreferrer" className="p-3 rounded-full bg-muted hover:bg-primary hover:text-white transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                ...
                <a href="https://in.linkedin.com/company/earney" target="_blank" rel="noopener noreferrer" className="p-3 rounded-full bg-muted hover:bg-primary hover:text-white transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
