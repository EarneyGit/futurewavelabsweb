...
const ParticleWave: React.FC<ParticleWaveProps> = ({ className = '' }) => {
  ...
  // Function to get particle color (always white)
  const getParticleColor = () => {
    return new THREE.Vector3(1.0, 1.0, 1.0); // Always white particles
  };
  ...
  const initScene = () => {
    ...
    const particleMaterial = new THREE.ShaderMaterial({
      ...
      uniforms: {
        ...
        uColor: { type: 'v3', value: getParticleColor() }
      }
    });
  ...
  const animate = () => {
    ...
    // Update particle color (always white)
